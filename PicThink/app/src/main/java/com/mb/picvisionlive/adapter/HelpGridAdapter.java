...
public class HelpGridAdapter extends BaseAdapter{
    ...
    public HelpGridAdapter(Context context, List<QuestionBean> list){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view != null) {
            ...
            paramView= LayoutInflater.from(context).inflate(R.layout.item_help_grid,null);
            holder.question_txt=(TextView)paramView.findViewById(R.id.item_help_grid_question_txt);
