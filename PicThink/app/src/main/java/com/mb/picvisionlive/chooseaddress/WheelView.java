...
package com.mb.picvisionlive.chooseaddress;
...
import com.mb.picvisionlive.chooseaddress.adapter.WheelViewAdapter;
import com.mb.picvisionlive.chooseaddress.views.ItemsRange;
import com.mb.picvisionlive.chooseaddress.views.OnWheelChangedListener;
import com.mb.picvisionlive.chooseaddress.views.OnWheelClickedListener;
import com.mb.picvisionlive.chooseaddress.views.OnWheelScrollListener;
import com.mb.picvisionlive.chooseaddress.views.WheelRecycle;
import com.mb.picvisionlive.chooseaddress.views.WheelScroller;
...
public class WheelView extends View {
	 ...
	 */
	private int[] SHADOWS_COLORS = new int[] { 0x00AAAAAA, 0x00AAAAAA,0x00AAAAAA };
	...
	private void drawCenterRect(Canvas canvas) {
		...
		/*
		 * / 使用自己的画线，而不是描边 Rect rect = new Rect(left, top, right, bottom) centerDrawable.setBounds(bounds) centerDrawable.setBounds(0, center - offset, getWidth(), center + offset); centerDrawable.draw(canvas); //
		 */
